...
export function AgendaPage() {
  ...
  React.useEffect(() => { setIsDelConfOpen(deleteId !== null); }, [deleteId]);
    ...
    <div className="space-y-4">
                ...
                <div className="flex items-center gap-1">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem onClick={() => setEditAppt(a)} className="text-blue-600">
      ...
      <Dialog open={deleteId !== null} onOpenChange={o => { if(!o) setDeleteId(null); }}>
        <DialogContent className="max-w-sm">
          <DialogHeader><DialogTitle>Supprimer ce rendez-vous?</DialogTitle></DialogHeader>
          <p className="text-sm text-muted-foreground">Cette action est irréversible.</p>
          <DialogFooter>
            <Button variant="outline" onClick={() => setDeleteId(null)}>Annuler</Button>
            <Button variant="destructive" onClick={() => deleteId && deleteAppointment(deleteId)}>
              🗑️ Supprimer
            </Button>
          </DialogFooter>
        </DialogContent>
