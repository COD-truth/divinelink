...
// ── Pharmacy ─────────────────────────────────────────────────
export type DrugUnit = "comprimés" | "flacons" | "ampoules" | "sachets" | "gélules" | "ml" | "mg" | "autre";
export type DrugCategory = "Antibiotique" | "Antalgique" | "Antipaludéen" | "Antiparasitaire" | "Antihypertenseur" | "Antidiabétique" | "Vitamines" | "Anti-inflammatoire" | "Antiseptique" | "Anesthésique" | "Autre";
...
export type PaymentMode = "espèces" | "mtn" | "orange" | "autre";
...
class DentaDB extends Dexie {
  ...
  constructor() {
    ...
    this.version(8).stores({
      ...
      documents: "++id, patientId, name, tag, createdAt, updatedAt, clinicId",
      auditLogs: "++id, timestamp, userName, type, resource",
      drugs: "++id, name, category, clinicId, expiryDate",
      drugTransactions: "++id, drugId, type, patientId, clinicId, createdAt",
      payments: "++id, patientId, status, clinicId, createdAt",
    });
  }
}
